...
import com.api.processor.DataJugadoresProcessor;
...
public class JugadoresController {
    ...
    private final DataJugadoresProcessor dataJugadoresProccesor;

    @Autowired
    public JugadoresController(JugadorService jugadorService, DataJugadoresProcessor dataJugadoresProccesor) {
...
/*
    //Endpoint que permite pasar los jugadores a la tabla de la BBDD USAR SOLO UNA VEZ PARA EVITAR DUPLICADOS
