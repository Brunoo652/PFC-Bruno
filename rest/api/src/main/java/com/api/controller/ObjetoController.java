...
import com.api.processor.DataObjetosProcessor;
import com.api.service.ObjetoService;
...
public class ObjetoController {
    ...
    @GetMapping(value = "/objeto-nombre", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    /*
    //Endpoint para mandar a la BBDD los datos de los objetos USAR SOLO UNA VEZ PARA EVITAR DUPLICADOS
